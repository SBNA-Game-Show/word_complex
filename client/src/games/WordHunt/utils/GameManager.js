...
class GameManager {
  ...
  /**
   * Writes the game data generated by player to the database based on two criteria:
   * - User must be signed in
   * - Version played must be Sanskrit
   *
   * @param {*} bestTime
   * @param {*} hintsUsed
   * @param {*} foundWords
  ...
  /**
   * Verify if the played version is Sanskrit
   * @returns {boolean}
   */
  verifyLanguage() {
    return this.game.LANGUAGE === "SA";
  }
